...
우회는 막지 않되 **흔적을 남긴다**: ``KOIPA_ALLOW_DIRTY_FINALIZE=1`` 이면 통과하지만
...
BYPASS_ENV = "KOIPA_ALLOW_DIRTY_FINALIZE"
...
def require_clean_source_tree(
    ...
    *,
    ...
    우회(``KOIPA_ALLOW_DIRTY_FINALIZE=1``)는 통과시키되 ``bypassed=True`` 를 남긴다 —
