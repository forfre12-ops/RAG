...
def load_seeds_from_db() -> list[dict] | None:
    ...
    try:
        ...
        from koipa.db.models import ClassificationLevel, EvaluationFactor, LevelKeyword  # noqa: PLC0415
...
#                     provider는 EMB_PROVIDER=hash | koipa.config.settings.embedding_model 사용
