...
def make_label_fn(
    ...
    *,
    ...
    """
    from koipa.modules.m3_labeling import LabelingPipeline  # lazy
    from koipa.modules.m3_labeling.rule_engine import has_real_evidence as _has_evidence  # lazy

    rp = rule_pipeline or LabelingPipeline()
    if judge is None:
        from koipa.modules.m3_labeling.judge import build_consensus_judge  # lazy
