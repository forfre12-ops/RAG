...
class DocumentIngestionService:
    ...
    def ingest(
        ...
        *,
        ...
        try:
            from koipa.api.prom_metrics import DOCUMENTS_INGESTED_TOTAL  # noqa: PLC0415
    ...
    def _emit_extraction_degraded(reasons: list[str]) -> None:
        if not reasons:
            return
        try:
            from koipa.api.prom_metrics import EXTRACTION_DEGRADED_TOTAL  # noqa: PLC0415
            for r in reasons:
        ...
        *,
        ...
        def _do(session) -> object:
            ...
            if file_hash:
                ...
                from koipa.db.models import Document as _Doc  # noqa: PLC0415
