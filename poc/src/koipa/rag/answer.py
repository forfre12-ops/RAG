...
사용 예:
    from koipa.rag.answer import synthesize_answer
...
from koipa.adapters.llm.base import LLMProvider, LLMResponse
from koipa.schemas.classify import RagContextHit
from koipa.schemas.rag_answer import (
    RagAnswerResult,
    RagAnswerUsage,
    hits_to_citations,
)
...
def _citation_warnings(answer_text: str, n_hits: int) -> tuple[list[str], list[int]]:
    ...
    """
    from koipa.modules.m6_evaluation.answer_metrics import citation_metrics  # noqa: PLC0415
