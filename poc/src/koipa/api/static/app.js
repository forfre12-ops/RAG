...
/* [2026-08-24] 「실시간 반영 시연」은 이름과 달리 **실 DB 에 쓴다** — 문서를 등록하고
   교정·승급까지 한다(POST /documents · /relabel · /promotions/promote). 행위자는
...
/* 분석 진행 오버레이 — 구현은 upload_progress.js 로 옮겼다(세 화면 공용).
   index.html 이 모듈보다 먼저 그 스크립트를 읽으므로 여기서는 window 것을 쓴다. */
const analyzeProgress = window.UploadProgress;
