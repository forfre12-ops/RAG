...
// V2 통합본 §9 "FNR ≤ 5% 핵심" 절을 화면에서 실증.
// 출처: KOIPA 영업비밀 침해 동향 공개 통계 + 부정경쟁방지법 §18조 형사처벌 조항.
...
export const INCIDENT = {
  ...
  fnr_sequence: [
    ...
    },
    {
      step: 5,
      title: "사고 인지",
      detail: "평균 인지 시점 6~12개월 후 (KOIPA 통계)",
      tag: "지연 인지",
    },
    {
      step: 6,
      title: "법적 분쟁 + 손해",
      detail: "부경법 §18 형사처벌 + 민사 손해배상 + 기술 가치 하락",
      tag: "사후 대응",
    },
  ],
  ...
  // 손해 추정 (KOIPA 공개 통계 — 추정치 명시)
  estimates: [
    {
      label: "건당 평균 영업비밀 침해 손해액",
      value: "₩47.2억",
      note: "KOIPA 영업비밀 침해 동향 (공개 통계 평균값, 추정)",
    },
    {
      label: "AI 영업비밀 자동분류 도입 시 미탐 감소 목표",
      value: "≤ 5%",
      note: "V2 통합본 §9 핵심 KPI",
    },
    {
      label: "사고 인지 평균 지연",
      value: "6~12개월",
      note: "KOIPA 동향 보고서 (공개)",
    },
    {
      label: "형사처벌 기준",
      value: "부경법 §18",
      note: "10년 이하 징역 또는 5억 이하 벌금",
    },
  ],
};
