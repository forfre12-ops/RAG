...
from lloydk.rag.retrieval import expand_then_search as _expand_then_search
...
def expand_then_search(**kwargs):
    ...
    with span(
        ...
        **{
            "lloydk.rag.collection": kwargs.get("collection"),
            "lloydk.rag.method": kwargs.get("method", "rule"),
            "lloydk.rag.top_k": kwargs.get("top_k", 5),
            "lloydk.rag.use_reranker": bool(kwargs.get("use_reranker", True)),
        },
    ):
