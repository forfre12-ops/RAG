...
생성 버킷:
- koipa-docs   : 원본/정규화 문서 (raw/, normalized/, sample/)
- koipa-models : 학습된 모델 가중치 스냅샷
...
BUCKETS: tuple[str, ...] = (
    os.environ.get("MINIO_BUCKET_DOCS", "koipa-docs"),
    os.environ.get("MINIO_BUCKET_MODELS", "koipa-models"),
