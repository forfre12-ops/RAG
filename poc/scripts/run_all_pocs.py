...
STEPS: list[tuple[str, list[str]]] = [
    ...
    ("p3_synth", [sys.executable, str(_HERE / "p3_generate_synthetic.py"), "--total", "40", "--provider", "noop"]),
    ("p2_embedding", [sys.executable, str(_HERE / "p2_compare_embeddings.py"), "--mode", "dryrun"]),
