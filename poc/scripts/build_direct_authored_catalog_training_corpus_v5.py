...
v6 는 여기서 막힌 지점을 다르게 푼다: 결론 문장을 **지우는** 대신 **요인 수준으로 다시
쓴다.** 지우기가 안 되는 이유는 아래 _grade_verdict_sentences 주석과 _evidence_survival
진단 참조 — 인용 8,100건 중 7,150건이 그 문장 안에 있어서, 지우면 evidence 가 함께
사라진다. v6 결과: 길이-only 0.392 · tell 15종(커버 0.090) · 인용의 tell 포함 2.6% ·
레코드 2,700/2,700 검증 통과.

아래는 당시 진단 기록이다.

⚠ 게이트의 두 축 중 길이는 넘지만 tell 이 막는다:
