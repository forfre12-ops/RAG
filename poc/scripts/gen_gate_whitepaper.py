...
<div class="page">
  ...
  <article>
    ...
    <section id="s07">
      ...
      <p>모델이 비-TS를 자동확정할 때 로컬 LLM에게 2차의견을 받는 방식. golden500에서 <b>검수 19→49로 폭증</b>(LLM이 "모호하면 한 단계 위" 편향으로 과잉 에스컬레이션)하고 <b>TS 누출은 여전히 잔존(비결정론적)</b>, 100건에 57콜·21분. 비용 대비 효과가 나빠 <b>기본 off로 보존(비권장)</b>.</p>
