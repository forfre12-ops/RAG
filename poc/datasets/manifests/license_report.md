...
| `adversarial/golden_100.jsonl` | MIT | LloydK 자체 큐레이션 | ✅ | S9 적대적 FNR 게이트 |
| `p4_corpus` | MIT | LloydK 자체 생성 보일러플레이트 | ✅ | 발주처 실문서 도착 시 교체 |
...
3. **합성 데이터 IP 보호**: LloydK 자체 생성분(`synthetic_5k`·`labeled_5k`·`golden_100` 등)은 MIT 공개, 단 KOIPA 사업 IP는 사업 계약 별도 규정 우선.
