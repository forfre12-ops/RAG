...
class TestAnthropicProviderImport:
    def test_module_imports(self):
        ...
        from koipa.adapters.llm import anthropic_provider
    ...
    def test_init_requires_api_key(self, monkeypatch):
        ...
        from koipa.config import settings as _s
...
class TestOpenAIProviderImport:
    def test_module_imports(self):
        from koipa.adapters.llm import openai_provider
...
class TestVllmProviderImport:
    def test_module_imports(self):
        from koipa.adapters.llm import vllm_provider
...
class TestStorageMinio:
    def test_minio_store_imports(self):
        ...
        from koipa.adapters.storage import minio_store
...
class TestM3LlmLabeler:
    def test_llm_labeler_imports(self):
        ...
        from koipa.modules.m3_labeling import llm_labeler
...
class TestWorkers:
    def test_celery_app_imports(self):
        ...
        from koipa.workers import celery_app
