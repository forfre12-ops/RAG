...
| **Vector DB** | **Elasticsearch 8.15.3 단일** · InMemory(테스트) | `dense_vector` + BM25 + RRF 하이브리드, Kibana·ILM·audit log, KL 기존 인프라 재사용. Qdrant 롤백은 2026-05-27 v2 자체 결정으로 제거 |
